...
/** owghat(month,day,longitude,latitude,Show_seconds,Daylight_Saving_Time_On,farsi_numbers) // Version:1.2 _ http://123.scr.ir */

function owghat($m, $d, $lg, $lat, $seconds = 0, $dslst = 0, $farsi = 0)
{
